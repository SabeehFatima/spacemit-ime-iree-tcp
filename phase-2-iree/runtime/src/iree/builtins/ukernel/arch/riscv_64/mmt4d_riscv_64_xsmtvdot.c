...
#define IME_OUT(mt, nt) (out + ((mt) * atom) * N0 + (nt) * atom)
  ...
  for (int k = 0; k < K1; ++k) {
    ...
    acc0  = __riscv_smt_vmadot(acc0,  a0, b0, vl8);
    acc1  = __riscv_smt_vmadot(acc1,  a0, b1, vl8);
    acc2  = __riscv_smt_vmadot(acc2,  a0, b2, vl8);
    acc3  = __riscv_smt_vmadot(acc3,  a0, b3, vl8);
    acc4  = __riscv_smt_vmadot(acc4,  a1, b0, vl8);
    acc5  = __riscv_smt_vmadot(acc5,  a1, b1, vl8);
    acc6  = __riscv_smt_vmadot(acc6,  a1, b2, vl8);
    acc7  = __riscv_smt_vmadot(acc7,  a1, b3, vl8);
    acc8  = __riscv_smt_vmadot(acc8,  a2, b0, vl8);
    acc9  = __riscv_smt_vmadot(acc9,  a2, b1, vl8);
    acc10 = __riscv_smt_vmadot(acc10, a2, b2, vl8);
    acc11 = __riscv_smt_vmadot(acc11, a2, b3, vl8);
}
  vuint32m2_t idx = ime_out_index(N0, atom, log2_atom, vl32);
