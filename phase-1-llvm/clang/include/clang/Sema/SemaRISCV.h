...
public:
 ...
 /// Indicate RISC-V SpacemiT vector builtin functions enabled or not.
  bool DeclareSpacemiTVectorBuiltins = false;

  bool ConstructedRISCVVectorBuiltins = false;
  bool ConstructedRISCVSiFiveVectorBuiltins = false;
  bool ConstructedRISCVAndesVectorBuiltins = false;
  bool ConstructedRISCVSpacemiTVectorBuiltins = false;
